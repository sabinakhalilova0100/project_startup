...
urlpatterns = [
    ...
    path(
        "increase_product_quantity/<int:pk>",
        views.increase_product_quantity,
        name="increase-product-quantity",
    ),
    path(
        "reduce_product_quantity/<int:pk>",
        views.reduce_product_quantity,
        name="reduce-product-quantity",
    ),
    path(
        "change_product_quantity/",
        views.change_product_quantity,
